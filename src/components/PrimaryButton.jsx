  ...
  return (
    ...
    >
      <div
        ...
        //   }  ${disabled === true ? "text-gray-500" : "text-white"} bg-cover bg-center  d-flex align-items-center justify-content-center text-14 font-semibold`}
        className={`primary-button  ${disabled === true ? "text-gray-500" : "text-white"} bg-cover bg-center  d-flex align-items-center justify-content-center text-14 font-semibold`}
