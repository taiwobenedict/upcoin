        ...
        <div id='howtobuy'>
            <Hero className="container" height={100} container={800}>
                <div className="text-light">
                    <h1 className="heading-xl">Buy With Us</h1>
                    <p className="text-big bold">To start with, ensure you have a MetaMask wallet installed on your browser in order to connect your wallet to the platform.</p>
            ...
            <Section name='buy-token' className="container" pd="100px 0">
                <div className="buying-text">
                    <h1 className="bold">BUYING THE $UP TOKEN</h1>
                ...
                <div className="accordion-slider">
                    <div className="accordion-group">
                        <div className="header" style={{ border: "none" }}>
                            ...
                            <h4 className="heading text-left">
                                BUY <span className="pri-light-color">$FGHT</span> WITH A CARD
                            </h4>
                    ...
                    <div className="accordion-group">
                        <div className="header">
                            ...
                            <h4 className="heading text-left">
                                BUY <span className="pri-light-color">$FGHT</span> WITH A ETH
                            </h4>
                    ...
                    <div className="accordion-group">
                        <div className="header">
                            ...
                            <h4 className="heading text-left">
                                BUY <span className="pri-light-color">$FGHT</span> WITH USDT
                            </h4>
