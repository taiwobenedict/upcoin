        ...
        <div id='sup'>
            <Hero container={750} className="container">
                <div className="hero-context text-light">
                    ...
                    <div className="text-big bold " data-aos="zoom-out">Exclusively on Supelle, discover a wealth of business opportunities with valuable crypto assets and utility tokens (SUP).</div>
            ...
            {/* Become Member */}
            <Section name={"membership"} mt={120} className="container">
                <div className="row" data-aos="zoom-in">
                    <div className="col-md-6 mt-3 pr-sm-5 d-flex justify-content-center align-items-center order-2">
                        <div className="endless-context">
                            <h1 className="pri-color heading-md">Become a Supcoin Token holder today to enjoy Supcoin discounts!
                            </h1>
            ...
            <Section name={"backdoor"} mt={120} className="border-top container">
                    ...
                    <div className="row">
                        <div className="col-md-6 mt-3 pr-sm-5 d-flex justify-content-center align-items-center">
                            <div className="endless-context" data-aos="fade-right">
                                <h3 className='heading-sm'>Be one of the early birds to own Supcoin (SUP) and increase your wealth tremendously!
            ...
            {/* Community */}
            <Section name={"community"} mt={120} className="border-top" >
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 mt-3 pr-sm-5 d-flex justify-content-center align-items-center">
                            <div className="endless-context" data-aos="fade-right">
                                <h3 className='heading-sm'>Our Inspiring Community is The Place to Be</h3>
                                <p className="mt-2 text-big">Communities are created when people share a common purpose. The growth of the Supcoin community is the immense growth   of every member. We encourage involvement and investment because we want you to reach your maximum potential too.
            ...
            <Section name={"revolution"} mt={120}>
